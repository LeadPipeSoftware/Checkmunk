...
namespace Checkmunk.Domain.Users.ValueObjects
{
    ...
    public struct PhoneNumber
    {
        ...
        /// </remarks>
        public string ExchangeCode => exchangeCode;
        ...
        public bool IsEasilyRecognizableAreaCode => this.areaCode.ElementAt(2).Equals(this.areaCode.ElementAt(3));
        ...
        /// </remarks>
        public string SubscriberNumber => subscriberNumber;
